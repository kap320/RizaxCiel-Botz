...
let handler = async function (m, { text, usedPrefix, command }) {
  ...
  if (user.registered === true) return conn.relayWAMessage(conn.prepareMessageFromContent(m.chat, {
        "listMessage": {
          ...
          "buttonText": "Riza『XYZツ』",
          "listType": "SINGLE_SELECT",
          "sections": [
                            {
                                "rows": [{
                                         "title": `LIST MENU`,
                                         "description": "List Menu © Riza「XYZ」",
                                         "rowId": ".menu"
                                    }, {
                                         "title": `MY OWNER`,
                                         "description": "List Owner © Riza「XYZ」", 
                                         "rowId": ".nowner"
                                    }, {
                                         "title": `UNREGISTER`,
          ...
          "sections": [
                            {
                                "rows": [{
                                         "title": `LIST MENU`,
                                         "description": "List Menu Riza『XYZツ』",
                                         "rowId": ".menu"
                                    }, {
                                         "title": `CODE REGISTER`,
