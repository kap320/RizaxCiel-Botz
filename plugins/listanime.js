...
let handler = async (m, { conn }) => await conn.sendButtonLoc(m.chat,await (await fetch(fla + 'List Anime')).buffer(),`*—「 LIST ANIME 」—*
${readMore}
