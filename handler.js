...
"headerType": "DOCUMENT", "documentMessage": {
  ...
  }}, 'buttonsMessage', { quoted: false, contextInfo: { mentionedJid: [user], forwardingScore: 999, isForwarded: true, externalAdReply: { title: wm, body: 'Riza「XYZ」 ', description: ' Recode By RizaxCiel', mediaType: 2, thumbnail: img, mediaUrl: `https://youtube.com/UCeCyBQogA_cJT9JMNLAJM8A`}}})
            }
          }
        }
        break
...
#daftar manusia.18`,
  ...
  if (msg) return conn.send2Button(m.chat, msg, wm, 'Pemilik Bot🌝', '.owner🌜', 'Rules🌞', '.rules', '.Donasi', m)
}
